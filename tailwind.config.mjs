  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 8px rgba(0,179,255,.18), 0 0 22px rgba(0,179,255,.10)' },
          '100%': { boxShadow: '0 0 16px rgba(0,179,255,.32), 0 0 44px rgba(0,179,255,.18)' },
        },
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #0F141A 0%, #141A22 55%, #0F141A 100%)',
