...
export const featuredProducts: Product[] = [
    ...
    configurations: [
      {
        ...
        points: [
          "Мишень ПМУ‑100",
          "Wi‑Fi управление",
          "Встроенный принтер с автообрезкой",
        ],
      },
      {
        title: "Рабочее место оператора",
        points: [
          "ПК/ноутбук оператора (опционально)",
          "Протоколы тренировок и управление сериями",
        ],
      },
      {
        title: "Пульт стрелка",
        points: [
          "Выносной Wi‑Fi пульт",
          "Быстрый старт/сброс/печать без оператора",
        ],
      },
      {
        title: "Под ТЗ",
        points: [
          "Интеграция в систему тира",
          "Адаптация под условия объекта и сценарии упражнений",
        ],
      },
    ],
    specs: {
    ...
    configurations: [
      {
        ...
        points: [
          "Мишень ПМУ‑25",
          "Wi‑Fi связь",
          "Автономная работа, встроенная АКБ",
        ],
      },
      {
        title: "С выносным табло",
        points: [
          "Табло результатов для стрелковой линии",
          "Удобно для групповых занятий и работы с инструктором",
        ],
      },
      {
        title: "Со стойкой",
        points: [
          "Стойка/крепление под объект",
          "Быстрое развёртывание и перенос",
        ],
      },
      {
        title: "Под ТЗ",
        points: [
          "Адаптация под сценарии и условия",
          "Интеграция в комплекс/тир при необходимости",
        ],
      },
    ],
    specs: {
  ...
  },
  {
    ...
    configurations: [
      {
        ...
        points: [
          "Установка ПУМА‑35",
          "Управление с пульта",
          "Базовые сценарии движения и остановки",
        ],
      },
      {
        title: "Интеграция в центральную систему",
        points: [
          "Подключение к АСУ тира",
          "Синхронизация со светом/сигналами",
          "Сложные сценарии упражнений",
        ],
      },
      {
        title: "Расширенная механика",
        points: [
          "Доп. датчики/ограничители (по ТЗ)",
          "Адаптация рубежей и креплений",
          "Условия объекта (температура/пыль)",
        ],
      },
      {
        title: "Под ТЗ",
        points: [
          "Длина, рубежи, скорость/ускорение",
          "Интеграция с мишенными модулями",
          "Комплектность под проект",
        ],
      },
    ],
    specs: {
    ...
    related: [
      "beguschiy-kaban-trosovaya-ustanovka",
      "trosovaya-ustanovka-pmu-tr2",
      "poperechnaya-trosovaya-ustanovka-puma-90",
    ],
  },
  {
    id: "multilaser",
...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    category: "electronic",
    shortDescription:
      "PUMA-51 это автономная, беспроводная мишень для стрельбы из пневматики.",
    description:
      "PUMA-51 это автономная, беспроводная мишень для стрельбы из пневматики. Мишень передает данные о времени попадания и начисленных очках в открытую сеть WiFi.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "moving",
    shortDescription:
      "ПУМА ТР - это линейка моделей тросовых мишенных установок, обеспечивающих перемещение мишени для стрельбы из любого пневматического оружия о",
    description:
      "ПУМА ТР - это линейка моделей тросовых мишенных установок, обеспечивающих перемещение мишени для стрельбы из любого пневматического оружия от стрелка на рубеж и обратно. Установка позволяет быстро перемещать мишень с размерами 30х30см на фиксированную при монтаже дистанцию (от5 до 15м) и возвращать ее обратно через устанавливаемое время (0-100сек).",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
    ...
    images: ["/images/products/trosovaya-ustanovka-pmu-tr2.svg"],
  },
  {
    ...
    category: "electronic",
    shortDescription:
      "Игровая мишень предназначена для установки на заднюю дугу багги.",
    description:
      "Игровая мишень предназначена для установки на заднюю дугу багги. Водители нескольких багги, уклоняясь и преследуя друг друга, стреляют из стрейкбольного оружия, стараясь попасть в мишень.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "moving",
    shortDescription:
      "ПУМА 90 - монорельсовая мишенная установка для перемещения мишени поперек стрелковой галереи на огневом рубеже.",
    description:
      "ПУМА 90 - монорельсовая мишенная установка для перемещения мишени поперек стрелковой галереи на огневом рубеже. Не мешает мультимедийному экрану, если он установлен.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "moving",
    shortDescription:
      "Потолочная монорельсовая мишенная установка (далее установка, изделие) предназначена для подвоза легких мишеней размера №4 с дистанций (рубе",
    description:
      "Потолочная монорельсовая мишенная установка (далее установка, изделие) предназначена для подвоза легких мишеней размера №4 с дистанций (рубежей) на удалениях 25м при обучении стрельбе на различных удалениях. Подвижная роликовая каретка, перемещающаяся по прикрепленному к потолку помещения тира сборному монорельсу с необходимой пользователю длиной, с прикрепленным к ней мишенным щитом, обеспечивает показ грудной мишени №4 на выбранных удалениях (рубежах) путем поворота мишенного щита из транспортного положения «ребром» в боевое положение (на заданное время).",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "electronic",
    shortDescription:
      "Компактная, автономная электронная мишень для стрельбы стальными шарами или свинцовыми пулями из пневматического оружия, а так же из малокал",
    description:
      "Компактная, автономная электронная мишень для стрельбы стальными шарами или свинцовыми пулями из пневматического оружия, а так же из малокалиберного огнестрельного 5,6мм - предназначена для тренировочной и развлекательной стрельбы. Быстросъемная бумажная мишень на бланке 140х140мм любого типа точно и быстро центруется визуально, по внешней окружности D130мм.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    description:
      "Краткое описание будет уточнено под ваш проект. Оборудование XTIR разрабатывается и производится под задачу; возможна адаптация характеристик.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "moving",
    shortDescription:
      "ПУМА 35 это монорельсовая тросовая установка, предназначенная для перемещения мишени от стрелка на нужный рубеж и обратно.",
    description:
      "ПУМА 35 это монорельсовая тросовая установка, предназначенная для перемещения мишени от стрелка на нужный рубеж и обратно. Питание установки осуществляется от безопасно низкого напряжения.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    images: ["/images/products/povorotka-na-dve-misheni-pmu-8s.svg"],
  },
  {
  ...
  },
  {
    ...
    category: "misc",
    shortDescription:
      "ПМУ-9 Шатун это мобильная мишенная установка, предназначенная для стрельбы из всех носимых видов оружия по качающейся цели.",
    description:
      "ПМУ-9 Шатун это мобильная мишенная установка, предназначенная для стрельбы из всех носимых видов оружия по качающейся цели. В отличие от аналогов",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
    ...
    images: ["/images/products/shatun-pmu-9.svg"],
  },
  {
    id: "biatlon-puma-45",
  ...
  },
  {
    ...
    category: "lifters",
    shortDescription:
      "ПМУ-7 (торговая марка ПУМА 3) - переносная автономная мишенная установка, предназначенная для показа ростовых мишеней из пластика путем их п",
    description:
      'ПМУ-7 (торговая марка ПУМА 3) - переносная автономная мишенная установка, предназначенная для показа ростовых мишеней из пластика путем их подъема и опускания в полевых условиях. Имеет "стаканы" для закрепления мишени, благодаря чему может использоваться для подачи мишени из-за угла или препятствий, в проемах зданий, из окопа и т.п.',
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "misc",
    shortDescription:
      "ПМУ-50 это радиоуправляемая мишенная тележка, предназначенная для использования как в закрытых помещениях, так и на открытой специально подг",
    description:
      "ПМУ-50 это радиоуправляемая мишенная тележка, предназначенная для использования как в закрытых помещениях, так и на открытой специально подготовленной местности (полигонах), в целях обучения стрельбе по движущимся целям из любого носимого оружия. Управление движением тележки в пределах прямой видимости - осуществляет оператор с помощью пульта управления, имеющего джойстик. При потере связи ПМУ-50 автоматически останавливается.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "electronic",
    shortDescription:
      "Автономная электронная мишень для стрельбы стальными шарами или свинцовыми пулями из пневматического оружия, а так же из малокалиберного огн",
    description:
      "Автономная электронная мишень для стрельбы стальными шарами или свинцовыми пулями из пневматического оружия, а так же из малокалиберного огнестрельного 5,6мм - предназначена для тренировочной и развлекательной стрельбы. Возможна установка броневой плиты для использования легкого огнестрельного оружия - ПМ и т.п.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    images: ["/images/products/modul-dlya-podema-mishennogo-torsa-puma-10.svg"],
  },
  {
    ...
    category: "turners",
    shortDescription:
      'ПУМА 4 это мобильная мишенная установка, предназначенная для показа ростовых мишеней путем их поворота в положения "боевое" и "ребром".',
    description:
      'ПУМА 4 это мобильная мишенная установка, предназначенная для показа ростовых мишеней путем их поворота в положения "боевое" и "ребром". Механизм электропривода содержит резиновые муфты и ограничители, смягчающие нагрузки от случайных ударов и усилий в процессе эксплуатации.',
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
    ...
    images: ["/images/products/povorotka-na-odnu-mishen-puma-4.svg"],
  },
  {
    ...
    category: "lift_turn",
    shortDescription:
      "Автономная мишенная установка ПМУ-15 предназначена для быстрого развертывания мишенной обстановки в полевых условиях или закрытых тирах - сл",
    description:
      "Автономная мишенная установка ПМУ-15 предназначена для быстрого развертывания мишенной обстановки в полевых условиях или закрытых тирах - случаях, когда требуется сложное управление мишенью (её поворот в положение ребром-чужой и подъем-опускание) и использовании носимого пневматического или огнестрельного оружия. ПМУ-15 обеспечивает высокую скорость смены положения мишени и способна работать при пониженных температурах.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
    ...
    images: ["/images/products/podemno-povorotnyy-podemnik-pmu-15.svg"],
  },
  {
    ...
    shortDescription:
      'ПМУ-12 это автономный, малогабаритный "оконный" подъемник, предназначенный для монтажа в дверных и оконных проемах и позволяющий имитировать',
    description:
      'ПМУ-12 это автономный, малогабаритный "оконный" подъемник, предназначенный для монтажа в дверных и оконных проемах и позволяющий имитировать появление в них головы снайпера, наблюдателя и т.п. Две и более таких установок могут быть быстро смонтированны и работать совместно, по одному сценарию, от радиосигналов управляющего ПК или пульта.',
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "accessories",
    shortDescription:
      "Автоматический поппер для практической стрельбы на открытой местности.",
    description:
      "Автоматический поппер для практической стрельбы на открытой местности. Управляется встроенным таймером или радиобрелком.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "systems",
    shortDescription:
      'Предлагаемый комплект оборудования предназначен для "перехватывания" управления мишенным полем на полигонах, где имеющиеся пульты управления',
    description:
      'Предлагаемый комплект оборудования предназначен для "перехватывания" управления мишенным полем на полигонах, где имеющиеся пульты управления оказались неисправными или устаревшими, не позволяющими решать текущие тактические задачи подготовки стрелков на современном уровне. Подключение плат управления к полигонной сети не вносит никаких изменений в существующую схему подключений и не мешает её обычной работе.',
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    images: ["/images/products/modul-povorota-misheni-puma-4a.svg"],
  },
  {
    ...
    category: "lift_turn",
    shortDescription:
      "Подъемно-поворотная мишенная установка ПМУ-4 предназначена для эксплуатации в закрытом боевом тире.",
    description:
      "Подъемно-поворотная мишенная установка ПМУ-4 предназначена для эксплуатации в закрытом боевом тире. Для удобства перемещения - смонтирована на раме с колесиками.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    images: ["/images/products/povorotnyy-podemnik-puma-4v.svg"],
  },
  {
    ...
    category: "ceiling_wall",
    shortDescription:
      "ПМУ МР - потолочная мишенная установка, специально созданная для условий закрытого тира, в котором уже имеется мультимедийный экран - но ест",
    description:
  ...
  },
  {
    ...
    category: "lift_turn",
    shortDescription:
      "Подъемно-поворотная мишенная установка ПМУ-5 предназначена для работы в закрытых помещениях (тирах) - а так же на открытой местности в услов",
    description:
      "Подъемно-поворотная мишенная установка ПМУ-5 предназначена для работы в закрытых помещениях (тирах) - а так же на открытой местности в условиях отсутствия осадков. Может управляться от носимых пультов или от центрального управляющего компьютера.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    category: "texts",
    shortDescription:
      "ПМУ-25 это автономная, беспроводная мишень для стрельбы из пневматики и одновременно, из электронного оружия (лазерного).",
    description:
      'ПМУ-25 это автономная, беспроводная мишень для стрельбы из пневматики и одновременно, из электронного оружия (лазерного). Для работы мишени не требуется внешний компьютер или проектор - мишень вполне "самодостаточна".',
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
  ...
  },
  {
    ...
    images: ["/images/products/tochnost-opredeleniya-koordinat.svg"],
  },
  {
  ...
  },
  {
    ...
    category: "misc",
    shortDescription:
      "Предлагаемый для самостоятельной установки комплект, состоящий из электронной платы, лазерного модуля, микровыключателя и пьезоэлемента - по",
    description:
      "Предлагаемый для самостоятельной установки комплект, состоящий из электронной платы, лазерного модуля, микровыключателя и пьезоэлемента - позволит практически любое оружие превратить в электронное (лазерное). После установки этого комплекта - оружие можно использовать для стрельбы в 99% лазерных тирах.",
    features: [
      "Надежная конструкция",
      "Интеграция в сценарии стрельбы",
      "Возможность кастомизации под задачу",
    ...
    images: ["/images/products/komplekt-dlya-peredelki-oruzhiya-pod-lazer.svg"],
  },
];
...
function pickHighlightsFromSpecs(
  ...
  for (const key of preferred) {
    if (specs[key] && items.length < 4)
      items.push({ label: key, value: specs[key] });
  }
  if (items.length < 4) {
  ...
  switch (category) {
    case "electronic":
      return {
        useCases: [
          {
            title: "Учебные тиры",
            text: "Отработка навыков и контроль результатов. Удобно для групповых занятий и инструкторов.",
          },
          {
            title: "Клубы и секции",
            text: "Стабильная эксплуатация в режиме потока: быстрое обслуживание, понятная логика работы.",
          },
          {
            title: "Мобильные комплексы",
            text: "Гибкая установка и минимальная инфраструктура: можно разворачивать под задачу.",
          },
        ],
        howItWorks: [
          {
            title: "Оптические/сенсорные измерения",
            text: "Попадания фиксируются датчиками/оптикой и преобразуются в координаты с заданной точностью.",
          },
          {
            title: "Сценарии и протокол",
            text: "ПО отображает результаты, серии, СТП/КТП и сохраняет данные для анализа и отчётности.",
          },
          {
            title: "Связь и управление",
            text: "Wi‑Fi/радиоканал, работа с пульта или ПК оператора — в зависимости от комплектации.",
          },
        ],
        configurations: [
          {
          ...
          },
          {
            title: "Расширенная",
            points: [
              "Доп. режимы и сценарии",
              "Выносные элементы (табло/пульт)",
              "Подключение к ПК оператора",
            ],
          },
          {
            title: "Под ТЗ",
            points: [
              "Интеграция в систему тира",
              "Адаптация под условия объекта (свет/пыль/температура)",
              "Комплектность под проект",
            ],
          },
        ],
    ...
    case "hanging":
      return {
        useCases: [
          {
            title: "Учебные полигоны",
            text: "Динамические упражнения и отработка сценариев. Надёжная механика под интенсивную эксплуатацию.",
          },
          {
            title: "Ведомственные тиры",
            text: "Программируемые рубежи и сценарии, интеграция в упражнение, управление с центрального поста.",
          },
          {
            title: "Спортивные объекты",
            text: "Репетиция дисциплин и упражнений, точное повторение траекторий и режимов.",
          },
        ],
        howItWorks: [
          {
            title: "Привод и кинематика",
            text: "Электропривод обеспечивает заданные режимы движения/поворота/подъёма с торможением и ограничителями.",
          },
          {
            title: "Сценарии",
            text: "Управление по рубежам: программируемые остановки, ускорение, задержки и реакции на сигналы.",
          },
          {
            title: "Управление",
            text: "Пульт или центральная система. Возможна синхронизация со светом/звуком и другими мишенными модулями.",
          },
        ],
        configurations: [
          {
            ...
            points: [
              "Установка",
              "Управление с пульта",
              "Базовые сценарии движения/остановки",
            ],
          },
          {
            title: "Интеграция в центральную систему",
        ...
        useCases: [
          {
            ...
            text: "Изделие подбирается под задачу и условия объекта, возможно изготовление по ТЗ.",
          },
          {
            title: "Модернизация объектов",
            text: "Интеграция в существующие тиры и комплексы, добавление функций и сценариев.",
          },
          {
            title: "Комплектность",
            text: "Поставка в составе системы: крепёж, кабели, пульты, элементы управления и документация.",
          },
        ],
        howItWorks: [
          {
            title: "Инженерный подход",
            text: "Проектирование, изготовление и настройка под сценарии эксплуатации и требования заказчика.",
          },
          {
            title: "Интеграция",
            text: "Подключение к существующим системам управления и сигналам (по ТЗ).",
          },
          {
            title: "Сервис и поддержка",
            text: "Документация, консультации по монтажу и эксплуатации, сопровождение проекта.",
          },
        ],
        configurations: [
          {
            ...
            points: [
              "Изделие",
              "Крепёж/монтажный комплект",
              "Базовые настройки",
            ],
          },
          {
            title: "Расширенная",
            points: ["Доп. функции и модули", "Интеграция", "Сценарии"],
          },
          {
            title: "Под ТЗ",
            points: [
              "Адаптация характеристик",
              "Комплектность под проект",
              "Документация",
            ],
          },
...
function applyDefaults(p: Product): Product {
  ...
  const highlights = p.highlights?.length
    ? p.highlights
    : pickHighlightsFromSpecs(p.specs);
  ...
  const configurations = p.configurations?.length
    ? p.configurations
    : base.configurations;
  const orderSteps = p.orderSteps?.length
    ? p.orderSteps
    : [...DEFAULT_ORDER_STEPS];
