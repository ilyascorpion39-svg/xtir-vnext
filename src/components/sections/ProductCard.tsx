  ...
  return (
    ...
    >
      <div className="relative aspect-[16/9] overflow-hidden bg-dark-900/70">
        {/* Фоновая подсветка категории + тех-линии */}
        <div
        ...
        <img
          ...
          alt={product.name}
          loading="lazy"
          className="absolute inset-0 h-full w-full object-cover opacity-90 transition-all duration-200 ease-out group-hover:opacity-100 group-hover:scale-[1.03]"
        />
