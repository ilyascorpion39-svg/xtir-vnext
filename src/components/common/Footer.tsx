          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-400 mb-6 max-w-sm">
                Разработка и производство электронно-механического оборудования для стрельбы. Современные технологии для профессиональной подготовки.
              </p>
      ...
      <div className="bg-dark-950 py-4">
        <div className="section-container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-600">
            <p>Сделано с ❤️ для точности и инноваций</p>
            <div className="flex items-center space-x-4">
              <a href="/sitemap.xml" className="hover:text-primary-500 transition-colors">
                Карта сайта
              </a>
              <span>•</span>
              <a href="/rss.xml" className="hover:text-primary-500 transition-colors">
                RSS
              </a>
            </div>
          </div>
