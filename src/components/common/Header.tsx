        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="relative w-12 h-12">
              <div className="absolute inset-0 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-lg opacity-20 group-hover:opacity-40 transition-opacity blur-xl"></div>
              <div className="relative w-full h-full bg-dark-800 rounded-lg flex items-center justify-center border border-primary-500/30 group-hover:border-primary-500 transition-colors">
                <span className="text-2xl font-display font-bold gradient-text">X</span>
              </div>
            </div>
            <div>
              <span className="text-xl font-display font-bold text-white group-hover:text-primary-500 transition-colors">
                XTIR
              </span>
              <p className="text-xs text-gray-400 font-sans">Точность технологий</p>
            </div>
          </motion.a>
          ...
          >
            <nav className="section-container py-6 space-y-4">
              ...
              <div className="pt-4 space-y-3">
                ...
                <a href="/contact" className="block w-full btn btn-primary text-center">
                  Заказать
                </a>
              </div>
            </nav>
