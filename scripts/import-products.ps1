...
# Russian display names for categories
$catNames = @{
    "lifters"    = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x9F,0xD0,0xBE,0xD0,0xB4,0xD1,0x8A,0xD1,0x91,0xD0,0xBC,0xD0,0xBD,0xD0,0xB8,0xD0,0xBA,0xD0,0xB8))
    "rotators"   = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x9F,0xD0,0xBE,0xD0,0xB2,0xD0,0xBE,0xD1,0x80,0xD0,0xBE,0xD1,0x82,0xD0,0xBA,0xD0,0xB8))
    "combo"      = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x9F,0xD0,0xBE,0xD0,0xB4,0xD1,0x8A,0xD1,0x91,0xD0,0xBC,0xD0,0xBD,0xD0,0xBE,0x2D,0xD0,0xBF,0xD0,0xBE,0xD0,0xB2,0xD0,0xBE,0xD1,0x80,0xD0,0xBE,0xD1,0x82,0xD0,0xBD,0xD1,0x8B,0xD0,0xB5))
    "ceiling"    = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x9F,0xD0,0xBE,0xD1,0x82,0xD0,0xBE,0xD0,0xBB,0xD0,0xBE,0xD1,0x87,0xD0,0xBD,0xD1,0x8B,0xD0,0xB5))
    "moving"     = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x94,0xD0,0xB2,0xD0,0xB8,0xD0,0xB6,0xD1,0x83,0xD1,0x89,0xD0,0xB8,0xD0,0xB5,0xD1,0x81,0xD1,0x8F))
    "suspended"  = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x9F,0xD0,0xBE,0xD0,0xB4,0xD0,0xB2,0xD0,0xB5,0xD1,0x81,0xD0,0xBD,0xD1,0x8B,0xD0,0xB5))
    "electronic" = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0xAD,0xD0,0xBB,0xD0,0xB5,0xD0,0xBA,0xD1,0x82,0xD1,0x80,0xD0,0xBE,0xD0,0xBD,0xD0,0xBD,0xD1,0x8B,0xD0,0xB5))
    "polygon"    = [System.Text.Encoding]::UTF8.GetString([byte[]](0xD0,0x9F,0xD0,0xBE,0xD0,0xBB,0xD0,0xB8,0xD0,0xB3,0xD0,0xBE,0xD0,0xBD,0xD1,0x8B))
}
...
foreach ($cid in $usedCats) {
    $displayName = if ($catNames.ContainsKey($cid)) { $catNames[$cid] } else { $cid }
    [void]$sb.AppendLine("  { id: `"$cid`", name: `"$(Esc $displayName)`" },")
}
[void]$sb.AppendLine("]")
[void]$sb.AppendLine("")
